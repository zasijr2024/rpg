...
export const ENGINE_SITE_URL_ENCODED = "http%3A%2F%2Fadarkroom.doublespeakgames.com";
...
export const originalStateMigrationSteps: StateMigrationStep[] = [
  ...
  },
  {
    from: 1.2,
    to: 1.3,
    summary: "StateManager moved legacy room, outside, world, ship, perk, thief, and city state into modern categories.",
    operations: [
      "remove room.fire",
