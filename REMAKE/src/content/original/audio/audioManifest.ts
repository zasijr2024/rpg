...
export const originalAudioManifest: OriginalAudioDefinition[] = [
  ...
  { key: "MUSIC_SILENT_FOREST", path: "audio/silent-forest.flac", kind: "music" },
  { key: "MUSIC_LONELY_HUT", path: "audio/lonely-hut.flac", kind: "music" },
  { key: "MUSIC_TINY_VILLAGE", path: "audio/tiny-village.flac", kind: "music" },
  { key: "MUSIC_MODEST_VILLAGE", path: "audio/modest-village.flac", kind: "music" },
  { key: "MUSIC_LARGE_VILLAGE", path: "audio/large-village.flac", kind: "music" },
  { key: "MUSIC_RAUCOUS_VILLAGE", path: "audio/raucous-village.flac", kind: "music" },
  { key: "MUSIC_FIRE_DEAD", path: "audio/fire-dead.flac", kind: "music" },
  { key: "MUSIC_FIRE_SMOLDERING", path: "audio/fire-smoldering.flac", kind: "music" },
  { key: "MUSIC_FIRE_FLICKERING", path: "audio/fire-flickering.flac", kind: "music" },
  ...
  { key: "EVENT_NOISES_OUTSIDE", path: "audio/event-noises-outside.flac", kind: "event" },
  { key: "EVENT_NOISES_INSIDE", path: "audio/event-noises-inside.flac", kind: "event" },
  { key: "EVENT_BEGGAR", path: "audio/event-beggar.flac", kind: "event" },
  { key: "EVENT_SHADY_BUILDER", path: "audio/event-shady-builder.flac", kind: "event" },
  { key: "EVENT_MYSTERIOUS_WANDERER", path: "audio/event-mysterious-wanderer.flac", kind: "event" },
  { key: "EVENT_SCOUT", path: "audio/event-scout.flac", kind: "event" },
  { key: "EVENT_WANDERING_MASTER", path: "audio/event-wandering-master.flac", kind: "event" },
  { key: "EVENT_SICK_MAN", path: "audio/event-sick-man.flac", kind: "event" },
  { key: "EVENT_RUINED_TRAP", path: "audio/event-ruined-trap.flac", kind: "event" },
  ...
  { key: "EVENT_BEAST_ATTACK", path: "audio/event-beast-attack.flac", kind: "event" },
  { key: "EVENT_SOLDIER_ATTACK", path: "audio/event-soldier-attack.flac", kind: "event" },
  { key: "EVENT_THIEF", path: "audio/event-thief.flac", kind: "event" },
  { key: "LANDMARK_FRIENDLY_OUTPOST", path: "audio/landmark-friendly-outpost.flac", kind: "landmark" },
  { key: "LANDMARK_SWAMP", path: "audio/landmark-swamp.flac", kind: "landmark" },
  ...
  { key: "LANDMARK_HOUSE", path: "audio/landmark-house.flac", kind: "landmark" },
  { key: "LANDMARK_BATTLEFIELD", path: "audio/landmark-battlefield.flac", kind: "landmark" },
  { key: "LANDMARK_BOREHOLE", path: "audio/landmark-borehole.flac", kind: "landmark" },
  { key: "LANDMARK_CRASHED_SHIP", path: "audio/landmark-crashed-ship.flac", kind: "landmark" },
  { key: "LANDMARK_SULPHUR_MINE", path: "audio/landmark-sulphurmine.flac", kind: "landmark" },
  { key: "LANDMARK_COAL_MINE", path: "audio/landmark-coalmine.flac", kind: "landmark" },
  { key: "LANDMARK_IRON_MINE", path: "audio/landmark-ironmine.flac", kind: "landmark" },
  { key: "LANDMARK_DESTROYED_VILLAGE", path: "audio/landmark-destroyed-village.flac", kind: "landmark" },
  { key: "ENCOUNTER_TIER_1", path: "audio/encounter-tier-1.flac", kind: "encounter" },
  { key: "ENCOUNTER_TIER_2", path: "audio/encounter-tier-2.flac", kind: "encounter" },
  { key: "ENCOUNTER_TIER_3", path: "audio/encounter-tier-3.flac", kind: "encounter" },
  ...
  { key: "WEAPON_UNARMED_1", path: "audio/weapon-unarmed-1.flac", kind: "weapon" },
  { key: "WEAPON_UNARMED_2", path: "audio/weapon-unarmed-2.flac", kind: "weapon" },
  { key: "WEAPON_UNARMED_3", path: "audio/weapon-unarmed-3.flac", kind: "weapon" },
  ...
  { key: "WEAPON_RANGED_1", path: "audio/weapon-ranged-1.flac", kind: "weapon" },
  { key: "WEAPON_RANGED_2", path: "audio/weapon-ranged-2.flac", kind: "weapon" },
  { key: "WEAPON_RANGED_3", path: "audio/weapon-ranged-3.flac", kind: "weapon" },
...
function assertKeysMatchManifest(): void {
  ...
  if (keys.join("\u0000") !== canonicalManifest.keys.audioConstants.join("\u0000")) {
