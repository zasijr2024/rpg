...
export const originalLocaleInventory: OriginalLocaleInventoryEntry[] = [
  ...
  {
    code: "lt_LT",
    dataPath: "DATA/locales/lt_LT.md",
    msgidEntries: 773,
    hasJs: true,
    hasPo: true,
    hasCss: true,
  ...
  {
    code: "pt_br",
    dataPath: "DATA/locales/pt_br.md",
    msgidEntries: 773,
    hasJs: true,
    hasPo: true,
    hasCss: true,
  ...
  {
    code: "zh_tw",
    dataPath: "DATA/locales/zh_tw.md",
    msgidEntries: 773,
    hasJs: true,
    hasPo: true,
    hasCss: true,
