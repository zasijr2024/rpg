...
| P14V-06 | Unassisted production playtests                    | P14V-05                            | playtest operators     | At least 3 valid same-revision, unique-participant records pass the strengthened gate; normally continue to 5 and up to 8 if outcomes remain inconsistent                                                                                          | ready for operators; 0/3          |
