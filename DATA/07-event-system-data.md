...
Event scheduling constants, scene/button interpretation, combat event mechanics, loot handling, reward/cost application, and event runtime behavior.

## Source Files

- `ORIGINAL/script/events.js` (1349 lines)

## `ORIGINAL/script/events.js`
