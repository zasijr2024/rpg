...
Current verdict: **HOLD for public Release Candidate sign-off**. P14V-01 evidence tooling is complete and the corrected policy now completes the fixed four-seed diagnostic in one aggregate run, but the current worktree is dirty, hosted CI has not yet run, the retained 32-seed corpus is still missing, no unassisted sessions are recorded, and current Space support has not been flown end-to-end with a real screen reader. Closure now fails closed for P14R/P14V, the manual Space fixture runs the normal clock without console controls, and the version-2 human gate enforces one decision cohort. The clean candidate, larger corpus, operator evidence, and remake license/NOTICE decision remain open.
...
| P14V-02 | Scope-safe checkpoint and clean reproduction       | P14V-01                            | maintainer             | Reviewed coherent commits exist on one revision; a separate clean checkout with initialized submodules passes `npm ci` and the technical RC gate                                                                                                   | pending                            |
...
| P14V-04 | Progression-policy validity                        | P14V-02                            | engineering            | Every current 0/4 failure is classified; legal death and Workshop recovery are represented; remaining failures distinguish policy, game defect, and source-authentic friction                                                                      | provisional: 4/4 in dirty worktree |
...
The original fixed four-seed result was 0/4: three first-expedition deaths and one Workshop recovery failure. The corrected dirty-worktree policy now completes 4/4 in one aggregate diagnostic run without changing game balance or injecting state/outcomes. That provisional P14V-04 result must be repeated on the P14V-02 frozen revision before it becomes candidate evidence:
